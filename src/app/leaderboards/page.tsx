      ...
      <Container className="py-4">
            ...
            <Row className="align-items-center">
              <Col>
                ...
                <small className="text-muted">
                  ...
                  {data.cached && <Badge bg="secondary" className="ms-2">Cached</Badge>}
                </small>
              </Col>
            </Row>
          </Card.Header>
                          ...
                          {playerChunk.map((player, index) => {
                            ...
                            return (
                              <tr key={player.uuid}>
                                <td>
                                  <Badge 
                                    bg={rank === 1 ? 'warning' : rank === 2 ? 'secondary' : rank === 3 ? 'success' : 'light'}
                                    text={rank <= 3 ? 'dark' : 'dark'}
                                  >
                                    {rank}
                                  </Badge>
                                </td>
        ...
        <div className="text-center mt-4">
          <p className="text-muted">
            Leaderboards are updated every 4 hours
          </p>
        </div>
      </Container>
